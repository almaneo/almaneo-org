...
import type { WalletModalProps, WalletTab, QuickAction } from './types';
...
export const WalletModal: React.FC<WalletModalProps> = ({
  ...
  const tabs: { id: WalletTab; label: string; enabled: boolean }[] = [
    ...
    { id: 'tokens', label: 'Tokens', enabled: enabledFeatures.tokens ?? true },
    { id: 'nft', label: 'NFT', enabled: enabledFeatures.nft ?? true },
    { id: 'game', label: 'Game', enabled: enabledFeatures.game ?? true },
    { id: 'staking', label: 'Staking', enabled: enabledFeatures.staking ?? true },
    { id: 'governance', label: 'DAO', enabled: enabledFeatures.governance ?? true },
          ...
          <div className="wallet-summary-card">
            ...
            <div className="wallet-summary-stats">
              <div className="wallet-summary-stat">
                ...
                <span className="value">{stakingSummary.stakedAmount} NEOS</span>
              </div>
              <div className="wallet-summary-stat">
...
// Tokens 탭
const TokensTab: React.FC<{ tokens: any[]; balance: string }> = ({ tokens, balance }) => (
  <div className="wallet-tab-content">
    <div className="wallet-token-list">
      ...
      {tokens.length === 0 && (
        <p className="wallet-empty-message">No tokens found</p>
      )}
    </div>
  </div>
);
...
// NFT 탭
const NFTTab: React.FC<{ summary: any }> = ({ summary }) => (
  <div className="wallet-tab-content">
    {summary ? (
...
// Game 탭
const GameTab: React.FC<{ summary: any }> = ({ summary }) => (
  <div className="wallet-tab-content">
    {summary ? (
...
// Staking 탭
const StakingTab: React.FC<{ summary: any }> = ({ summary }) => (
  <div className="wallet-tab-content">
    {summary ? (
      <div className="wallet-staking-summary">
        ...
        <div className="wallet-stat-grid">
          <div className="wallet-stat-item">
            <span className="label">Staked</span>
            <span className="value">{summary.stakedAmount} NEOS</span>
          </div>
          <div className="wallet-stat-item">
            <span className="label">Pending Rewards</span>
            <span className="value">{summary.pendingRewards} NEOS</span>
          </div>
          <div className="wallet-stat-item">
            <span className="label">APY</span>
      ...
      <div className="wallet-empty-state">
        <CoinsIcon />
        <p>Stake NEOS to earn rewards</p>
        <a href="/staking" className="wallet-action-btn">
          Start Staking
        </a>
      </div>
...
// Governance 탭
const GovernanceTab: React.FC<{ summary: any }> = ({ summary }) => (
  <div className="wallet-tab-content">
    {summary ? (
      <div className="wallet-governance-summary">
        <div className="wallet-stat-grid">
          <div className="wallet-stat-item">
            ...
            <span className="value">{summary.votingPower} NEOS</span>
          </div>
          <div className="wallet-stat-item">
