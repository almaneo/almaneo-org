...
const socialLinks = [
  { icon: TwitterXIcon, label: 'Twitter', url: 'https://x.com/almaneo_org' },
  { icon: DiscordIcon, label: 'Discord', url: 'https://discord.gg/JkRNuj7aYd' },
  { icon: TiktokIcon, label: 'TikTok', url: 'https://www.tiktok.com/@almaneo' },
  { icon: GithubIcon, label: 'GitHub', url: 'https://github.com/almaneo' },
];
